...
DOCKER_COMMAND="sudo chown -R $USERNAME:$USERNAME /home/$USERNAME; cd ..; source src/docker_humble_jetson/attach.sh; ros2 launch avionics_nexus launch.py"
