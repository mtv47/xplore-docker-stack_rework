...
DOCKER_COMMAND="sudo chown -R $USERNAME:$USERNAME /home/$USERNAME; source src/docker_humble_jetson/attach.sh; ros2 launch erc_drill drill.launch.xml"
...
if [ "$container_status" == "false" ]; then
    ...
    docker run -i \
        ...
        -v sc_humble_jetson_home_volume:/home/$USERNAME \
        $IMAGE_NAME \
